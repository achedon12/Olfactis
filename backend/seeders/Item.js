...
const seedItems = async () => {
    const items = [
        ...
        },
        {
            ...
            picture: 'glass_distillation_column.png',
            reference: 'DC-001',
            category: (await Category.findOne({ name: 'Distillation' })),
            state: (await State.findOne({ name: 'AVAILABLE' }))
        },
        ...
        },
        {
            ...
            picture: 'cold_press_extractor.png',
            reference: 'CP-001',
            category: (await Category.findOne({ name: 'Extraction' })),
            state: (await State.findOne({ name: 'AVAILABLE' }))
        },
        ...
        },
        {
            ...
            picture: 'ultrasonic_homogenizer.png',
            reference: 'UH-001',
            category: (await Category.findOne({ name: 'Mixing' })),
            state: (await State.findOne({ name: 'AVAILABLE' }))
        },
        ...
        // Glassware & Containers
        {
            ...
            picture: 'graduated_cylinders_set.png',
            reference: 'GCY-001',
        ...
        },
        {
            ...
            picture: 'erlenmeyer_flask_set.png',
            reference: 'EF-002',
            category: (await Category.findOne({ name: 'Glassware' })),
            state: (await State.findOne({ name: 'AVAILABLE' }))
        },
        ...
        // Testing & Packaging Equipment
        {
            ...
            picture: 'fragrance_testing_strips.png',
            reference: 'FTS-001',
        ...
        },
        {
            ...
            picture: 'perfume_bottling_machine.png',
            reference: 'PBM-001',
        ...
        },
        {
            ...
            picture: 'bottle_capping_machine.png',
            reference: 'BCM-001',
            category: (await Category.findOne({ name: 'Packaging' })),
            state: (await State.findOne({ name: 'AVAILABLE' }))
        }
