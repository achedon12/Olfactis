        ...
        <div className={'w-full h-screen flex flex-col items-center justify-center bg-pink-900'}>
            ...
            <form onSubmit={handleSubmit} className={'bg-white px-4 md:px-8 w-3/4 md:w-1/4'}>
                ...
                <div className={'flex justify-center items-center flex-col my-6'}>
                    <button type="submit" className={'w-1/3 p-2 my-2 bg-pink-500 text-white cursor-pointer'}>Login</button>
                    <p>Vous n'avez pas de compte ? <a href="/register" className={'text-pink-400'}>Inscrivez-vous</a></p>
                </div>
            </form>
        </div>
    );
